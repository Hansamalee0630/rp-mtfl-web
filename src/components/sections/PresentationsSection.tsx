...
export function PresentationsSection() {
  ...
  const presentations: SlideDeck[] = [
    ...
    },
    {
      ...
      status: "Submitted on 2026/05/04",
      isSubmitted: true,
      type: "Group",
      downloadLink: "https://drive.google.com/file/d/1Z5SylyTh267wcf-hJD4qIjW5rl47kLA1/view?usp=sharing",
      embedUrl: "https://www.canva.com/design/DAHIlO0AsBM/pGwTaiwFOpiMJjaN1MXc3w/view?embed"
    }
  ]
