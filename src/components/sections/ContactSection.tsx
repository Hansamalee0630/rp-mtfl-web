      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 text-cyan-400 font-bold mb-3 uppercase tracking-widest text-sm"
          >
            Contact Us
          </motion.div>
          <motion.h2 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <div className="pt-6 border-t border-white/10">
              <p className="font-semibold text-white/90">- Team ResearchTechsy</p>
              <p className="text-sm text-white/40 mt-1">Adaptive Personalized Multi-Task Federated Learning</p>
            </div>
          </motion.div>
