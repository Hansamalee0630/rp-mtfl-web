...
export function TimelineSection() {
  ...
  const timelineEvents = [
    ...
    { date: "04 May", year: "2026", title: "Website Evaluation and Final Presentation & VIVA", color: "from-yellow-500/20 to-transparent", border: "border-yellow-500/30", text: "text-yellow-400", dot: "bg-yellow-400", description: "Viva is held individually to assess each members contribution to the project.", marks: 20 },
    
    { date: "06 May", year: "2026", title: "Logbook Submission", color: "fromfrom-emerald-500/20 to-transparent", border: "border-emerald-500/30", text: "text-emerald-400", dot: "bg-emerald-400", description: "Status of the project is validated through the Logbook. This also includes, Status documents 1 & 2.", marks: 3 },
